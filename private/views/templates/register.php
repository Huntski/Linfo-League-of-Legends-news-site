...
<main class="flex">
    <div class="active-msg mobile-msg" style="display: none;">
    ...
    <form method="post" action="<?=$router->getCoreUrl();?>register" class="form-default">
        ...
        <p>Already have a account? <br>login<a href="<?=$router->getCoreUrl();?>login" style="color: #ffc45f"> here</a></p>
    </form>
