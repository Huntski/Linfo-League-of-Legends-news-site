...
<main class="flex">
    <div class="mobile-msg">
        ...
        <h2>To unlock free premium content.</h2>
    </div>
    <form method="post" action="<?=$uri?>register" class="form-default">
        ...
        <input type="email" name="email" autocomplete="on" class="inp-open <?php if (in_array("email", $empty)) echo "error"; ?>" placeholder="Email..">
        ...
        <p>Already have a account? <br>login<a href="<?=$uri?>login" style="color: #ffc45f"> here</a></p>
    </form>
